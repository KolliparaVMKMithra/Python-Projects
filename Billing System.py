...
class Bill_App:
    def __init__(self,root):
        ...
        cname_txt=Entry(F1,width=15,textvariable=self.c_name,font='arial 15 bold',bd=7,relief=SUNKEN).grid(row=0,column=1,pady=5,padx=10)

        cphn_label=Label(F1,text='Phone No:',bg=bg_color,fg='white',font=('times new roman',18,'bold')).grid(row=0,column=2,padx=20,pady=5)
        cphn_txt=Entry(F1,width=15,textvariable=self.c_phon,font='arial 15 bold',bd=7,relief=SUNKEN).grid(row=0,column=3,pady=5,padx=10)
        ...
        bath_lbl=Label(F2,text='Bath Soap',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=0,column=0,padx=10,pady=10,sticky='w')
        bath_txt=Entry(F2,width=10,textvariable=self.soap,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)

        Face_cream_lbl=Label(F2,text='Face Cream',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=1,column=0,padx=10,pady=10,sticky='w')
        Face_cream_txt=Entry(F2,width=10,textvariable=self.face_cream,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)

        Face_w_lbl=Label(F2,text='Face Wash',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=2,column=0,padx=10,pady=10,sticky='w')
        ...
        Hair_s_lbl=Label(F2,text='Hair Spray',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=3,column=0,padx=10,pady=10,sticky='w')
        ...
        Hair_g_lbl=Label(F2,text='Hair Gell',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=4,column=0,padx=10,pady=10,sticky='w')
        ...
        Body_lbl=Label(F2,text='Body Lotion',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=5,column=0,padx=10,pady=10,sticky='w')
        ...
        g1_lbl=Label(F3,text='Rice',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=0,column=0,padx=10,pady=10,sticky='w')
        ...
        g2_lbl=Label(F3,text='Food Oil',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=1,column=0,padx=10,pady=10,sticky='w')
        ...
        g3_lbl=Label(F3,text='Daal',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=2,column=0,padx=10,pady=10,sticky='w')
        ...
        g4_lbl=Label(F3,text='Wheat',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=3,column=0,padx=10,pady=10,sticky='w')
        ...
        g5_lbl=Label(F3,text='Sugar',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=4,column=0,padx=10,pady=10,sticky='w')
        ...
        g6_lbl=Label(F3,text='Tea',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=5,column=0,padx=10,pady=10,sticky='w')
        ...
        #======================Cool Drink Frame=================================
        F4=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cool Drinks",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        F4.place(x=670,y=180,width=325,height=380)

        c1_lbl=Label(F4,text='Maaza',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=1,column=0,padx=10,pady=10,sticky='w')
        c1_txt=Entry(F4,width=10,textvariable=self.maaza,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)

        c2_lbl=Label(F4,text='Coke',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=2,column=0,padx=10,pady=10,sticky='w')
        c2_txt=Entry(F4,width=10,textvariable=self.coke,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=10)

        c3_lbl=Label(F4,text='Frooti',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=3,column=0,padx=10,pady=10,sticky='w')
        c3_txt=Entry(F4,width=10,textvariable=self.frooti,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=3,column=1,padx=10,pady=10)

        c4_lbl=Label(F4,text='Thumbs Up',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=4,column=0,padx=10,pady=10,sticky='w')
        g4_txt=Entry(F4,width=10,textvariable=self.thumbsup,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)

        c5_lbl=Label(F4,text='Limca',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=5,column=0,padx=10,pady=10,sticky='w')
        ...
        c6_lbl=Label(F4,text='Sprite',font=("times new roman",16,'bold'),bg=bg_color,fg='light green').grid(row=6,column=0,padx=10,pady=10,sticky='w')
        c6_txt=Entry(F4,width=10,textvariable=self.sprite,font=("times new roman",16,'bold'),bd=5,relief=SUNKEN).grid(row=6,column=1,padx=10,pady=10)
        ...
        m3_lbl=Label(F6,text='Total Cool Drinks Price',bg=bg_color,fg='white',font=("times new roman",14,"bold")).grid(row=2,column=0,padx=20,pady=1,sticky='w')
        ...
        c3_lbl=Label(F6,text='Cool Drinks Tax',bg=bg_color,fg='white',font=("times new roman",14,"bold")).grid(row=2,column=2,padx=20,pady=1,sticky='w')
    ...
    def total(self):
        ...
        self.cool_drink_price.set("Rs "+str(self.total_drinks_price))
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END,'\tWelcome Mithra Retail\n')
    ...
    def bill_area(self):
        if self.c_name.get()==''or self.c_phon.get()=='':
            ...
            messagebox.showerror("Error","No Product Purchsed")
        else:  
            self.welcome_bill()
            #========Cosmetics=========
            if self.soap.get()!=0:
            ...
            if self.cool_drink_tax.get()!='Rs 0.0':
                self.txtarea.insert(END,f'\n Cool Drinks Tax\t\t\t{self.cool_drink_tax.get()}') 
    ...
    def save_bill(self):
        op=messagebox.askyesno("Save Bill",'Do You Wnat To Save Bill?')
        if op>0:
